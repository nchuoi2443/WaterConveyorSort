...
Outline *-- ListVector3""".splitlines()
    sections = [
        ...
        ("Conveyor", "Conveyor", {"ConveyorController", "ConveyorBuilder", "ConveyorBuoyGroup", "PathMoveSlot", "GroupPosition", "EnterRequest", "MaxBuoyCounterTxt"}),
        ("StackQueue", "Stack queue and exit", {"StackQueueController", "StackQueueVisual", "StackQueueExit", "StackReservation", "PendingReceive"}),
        ("Transfer", "Transfers", {"BuoyTransferController", "Transfer", "ReceiveTransfer", "ReceiveFlight", "Flight"}),
        ("Data", "Level data and enums", {"LevelDataSO", "BoardData", "PathData", "BuoyNodeData", "BuoyColumnData", "BuoyData", "ColumnElementData", "BuoyElementData", "ColorDataSO", "ColorEntryData", "ColumnElementType", "BuoyElementType", "MaxBuoyCounterTxtData"}),
