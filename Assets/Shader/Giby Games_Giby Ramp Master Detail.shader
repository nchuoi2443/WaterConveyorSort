Shader "Giby Games/Giby Ramp Master Detail" {
	Properties {
		...
		ENABLE_MASTER_DETAIL ("Master Detail", Int) = 0
		_MasterDetailColor ("Master Detail Color", Vector) = (1,1,1,1)
		_MasterDetailTex ("Master Detail Texture", 2D) = "white" {}
		_MasterDetailDissolveTex ("Master Detail Dissolve Texture", 2D) = "white" {}
		_MasterDetailDissolveValue ("Master Detail Dissolve Value", Range(0, 1)) = 0
		_MasterDetailDissolveGradientWidth ("Master Detail Dissolve Gradient Width", Range(0, 1)) = 0.2
		ENABLE_MASTER_DETAIL_OCCLUSION ("Master Detail Occlusion", Int) = 0
		_MasterDetailOcclusionColor ("Master Detail Occlusion Color", Vector) = (0,0,0,1)
		_MasterDetailOcclusionTex ("Master Detail Occlusion Texture", 2D) = "white" {}
		...
		[MaterialToggle] _ZWriteMode ("ZWrite", Float) = 1
	...
	Fallback "Diffuse"
	//CustomEditor "GibyRampMasterDetailGUI"
}